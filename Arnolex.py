...
Arnolex HACKER 💯
Arnolex🔴🔴
GRADE 10 STUDENT ⏏️⏏️
Philipines anonymous🇵🇭🇵🇭🇵🇭🇵🇭
...
In many cases (such as GMail) you can simply copy the above color faded text and paste it into your destination. If you cannot, copy and use the color code below.
    ...
    \033[1;94m::  
   \033[1;95m:::      
  \033[1;96m::♧♧♧♧♧♧♧♧♧♧\033[1;91mMobile Number\033[1;96m♧♧♧♧♧♧♧♧♧♧▒▒▒▒▒▒▒::::        
  \033[1;91m:》》》\033[1;93m+923232132362\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-Arnolex-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Arnolex......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Arnolex Taghoy
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
...
* ¸¸¸¸*__________________________* ¸¸¸¸*«┈┈┈┈┈┈┈┈┈ * ¸¸¸¸*«┈┈┈┈┈┈┈┈┈
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To Arnolex▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mArnolexHacker\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91Arnolex Webdeveloper
\033[1;94mBlackMafia\033[1;91m: \033[1;91▒▓██████████████]100.%
\033[1;94mFacebook\033[1;91m: \033[1;91Arnolexhacker
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923232132362
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96Arnolextaghoy\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................Balck mafia.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
...
CorrectUsername = "Arnolex"
CorrectPassword = "gwapoako"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Arnolex
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Arnolex hacker
	print logo
...
def pilih_super():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96Arnolex Taghoy\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---DEVELOPER BY ARNOLEX--•◈•---»" #Dev:Arnolex hacker
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....Arnolex cracking password........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                Mobile Number
               +639155052960"""
